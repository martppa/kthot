...
/**
 * Represents a reference to a JavaScript function that takes three parameters.
...
class JsFunction3Ref<Param1 : JsValue, Param2 : JsValue, Param3 : JsValue>(
     ...
     * ```javascript
     * functionReference(param1, param2, param3);
     * ```
    ...
    operator fun invoke(param1: Param1, param2: Param2, param3: Param3) =
        JsSyntax(InvocationOperation(this, param1, param2, param3))
}