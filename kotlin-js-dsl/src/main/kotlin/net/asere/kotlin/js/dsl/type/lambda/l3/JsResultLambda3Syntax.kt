...
class JsResultLambda3Syntax<Param1 : JsValue, Param2 : JsValue, Param3 : JsValue, Result : JsValue> @InternalApi constructor(
    value: String,
...
inline fun <Param1 : JsValue, Param2 : JsValue, Param3 : JsValue, Result : JsValue> JsLambda3.Companion.syntax(
    value: String,
