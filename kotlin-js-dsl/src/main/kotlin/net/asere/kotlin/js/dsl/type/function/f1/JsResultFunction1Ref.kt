...
class JsResultFunction1Ref<Param1 : JsValue, Result : JsValue>(
     ...
     */
    operator fun invoke(param: Param1) = resultTypeBuilder(InvocationOperation(this, param), false) // TODO: Improve nullability feature toa void depending on local property 'isNullable'
}