...
interface JsNavigator : JsObject {
     ...
     */
    val userAgent: JsString get() = JsStringSyntax("${this}.userAgent")
     ...
     */
    val platform: JsString get() = JsStringSyntax("${this}.platform")
     ...
     */
    val language: JsString get() = JsStringSyntax("${this}.language")
     ...
     */
    val onLine: JsBoolean get() = JsBooleanSyntax("${this}.onLine")
     ...
     */
    val cookieEnabled: JsBoolean get() = JsBooleanSyntax("${this}.cookieEnabled")
    ...
    */
    fun javaEnabled(): JsBoolean = JsBooleanSyntax("${this}.javaEnabled()")
    ...
    */
    val geolocation: JsObject get() = JsObjectSyntax("${this}.geolocation")
    ...
    */
    val mediaDevices: JsObject get() = JsObjectSyntax("${this}.mediaDevices")
    ...
    */
    val vendor: JsString get() = JsStringSyntax("${this}.vendor")
    ...
    */
    val appVersion: JsString get() = JsStringSyntax("${this}.appVersion")
}