...
/**
 * Represents a reference to a JavaScript async function that takes four parameters.
 ...
 */
class JsAsyncFunction4Ref<Param1 : JsValue, Param2 : JsValue, Param3 : JsValue, Param4 : JsValue>(
    name: String? = null,
) : JsFunctionRef(name) {
    /**
     ...
     * ```javascript
     * async functionName(param1, param2, param3, param4);
     * ```
     *
