...
import net.asere.kthot.js.dsl.syntax.operational.arithmetical.operation.ConcatOperation
...
interface JsString : JsValue {
     ...
     * @return A [net.asere.kthot.js.dsl.type.bool.JsBoolean] object indicating whether the string ends with the specified characters.
     */
