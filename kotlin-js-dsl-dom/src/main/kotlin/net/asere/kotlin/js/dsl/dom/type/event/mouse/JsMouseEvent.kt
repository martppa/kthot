...
interface JsMouseEvent : JsDomEvent {
     ...
     */
    val clientX: JsNumber get() = JsNumber.syntax(ChainOperation(this, "clientX"))
     ...
     */
    val clientY: JsNumber get() = JsNumber.syntax(ChainOperation(this, "clientY"))
     ...
     */
    val pageX: JsNumber get() = JsNumber.syntax(ChainOperation(this, "pageX"))
     ...
     */
    val pageY: JsNumber get() = JsNumber.syntax(ChainOperation(this, "pageY"))
     ...
     */
    val screenX: JsNumber get() = JsNumber.syntax(ChainOperation(this, "screenX"))
     ...
     */
    val screenY: JsNumber get() = JsNumber.syntax(ChainOperation(this, "screenY"))
     ...
     */
    val button: JsNumber get() = JsNumber.syntax(ChainOperation(this, "button"))
     ...
     */
    val buttons: JsNumber get() = JsNumber.syntax(ChainOperation(this, "buttons"))
