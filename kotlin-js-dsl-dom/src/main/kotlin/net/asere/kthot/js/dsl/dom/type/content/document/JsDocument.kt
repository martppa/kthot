 ...
 */
interface JsDocument : JsNode {

    /**
     * Returns a reference to the element by its ID.
     *
     * In JavaScript, this corresponds to `document.getElementById(id)`, but this method will always return a [JsHtmlElement].
     * @param id The ID of the element to find as a [JsString] object.
     * @return A [JsHtmlElement] representing the element, or `null` if no element with the specified ID exists.
     */
    fun getHtmlElementById(id: JsString): JsHtmlElement =
        JsHtmlElement.syntax(ChainOperation(this, InvocationOperation("getElementById", id)))

    fun getHtmlElementById(id: String): JsHtmlElement = getHtmlElementById(id.js)
     ...
     * @return A [JsHtmlCollection] containing all matching elements.
     */
    fun getElementsByClassName(className: JsString): JsHtmlCollection =
        JsHtmlCollection.syntax(ChainOperation(this, InvocationOperation("getElementsByClassName", className)))

    fun getElementsByClassName(className: String): JsHtmlCollection = getElementsByClassName(className.js)
     ...
     * @return A [JsHtmlCollection] containing all matching elements.
     */
    fun getElementsByTagName(tagName: JsString): JsHtmlCollection =
        JsHtmlCollection.syntax(ChainOperation(this, InvocationOperation("getElementsByTagName", tagName)))

    fun getElementsByTagName(tagName: String): JsHtmlCollection = getElementsByTagName(tagName.js)
     ...
     * @return A [JsHtmlCollection] containing all matching elements.
     */
    fun getElementsByName(name: JsString): JsHtmlCollection =
        JsHtmlCollection.syntax(ChainOperation(this, InvocationOperation("getElementsByName", name)))

    fun getElementsByName(name: String): JsHtmlCollection = getElementsByName(name.js)

    /**
     * Creates a new HTML element with the specified tag name.
     *
     * In JavaScript, this corresponds to `document.createElement(tagName)` but this method returns a [JsHtmlElement].
     * @param tagName The tag name of the element to create (e.g., "div", "span") as a [JsString] object.
     * @return A new [JsHtmlElement] representing the created element.
     */
    fun createDomElement(tagName: JsString): JsHtmlElement =
        JsHtmlElement.syntax(ChainOperation(this, InvocationOperation("createElement", tagName)))

    fun createDomElement(tagName: String): JsHtmlElement = createDomElement(tagName.js)
     ...
     * @return A new [JsNode] representing the created text node.
     */
    fun createTextNode(text: JsString): JsNode =
        JsNode.syntax(ChainOperation(this, InvocationOperation("createTextNode", text)))

    fun createTextNode(text: String): JsNode = createTextNode(text.js)
     ...
     * @return A new [JsNode] representing the created comment node.
     */
    fun createComment(text: JsString): JsNode =
        JsNode.syntax(ChainOperation(this, InvocationOperation("createComment", text)))

    fun createComment(text: String): JsNode = createComment(text.js)
     ...
     * @return A new [JsNode] representing the created `DocumentFragment`.
     */
    fun createDocumentFragment(): JsNode =
        JsNode.syntax(ChainOperation(this, InvocationOperation("createDocumentFragment")))
     ...
     */
    val documentElement: JsHtmlElement
        get() = JsHtmlElement.syntax(ChainOperation(this, "documentElement"))

    /**
     * Returns the `<body>` element.
     * Corresponds to `document.body` in JavaScript.
     */
    val body: JsBodyElement
        get() = JsBodyElement.syntax(ChainOperation(this, "body"))

    /**
     * Returns the `<head>` element.
     * Corresponds to `document.head` in JavaScript.
     */
    val head: JsHeadElement
        get() = JsHeadElement.syntax(ChainOperation(this, "head"))

    /**
     * Returns a live `HTMLCollection` of all forms in the document.
     * Corresponds to `document.forms` in JavaScript.
     */
    val forms: JsHtmlCollection
        get() = JsHtmlCollection.syntax(ChainOperation(this, "forms"))

    /**
     * Returns a live `HTMLCollection` of all images in the document.
     * Corresponds to `document.images` in JavaScript.
     */
    val images: JsHtmlCollection
        get() = JsHtmlCollection.syntax(ChainOperation(this, "images"))

    /**
     * Returns a live `HTMLCollection` of all links in the document.
     * Corresponds to `document.links` in JavaScript.
     */
    val links: JsHtmlCollection
        get() = JsHtmlCollection.syntax(ChainOperation(this, "links"))

    /**
     * Creates a new attribute node with the specified name.
     * Corresponds to `document.createAttribute(attributeName)`.
     */
    fun createAttribute(attributeName: JsString): JsNode =
        JsNode.syntax(ChainOperation(this, InvocationOperation("createAttribute", attributeName)))

    fun createAttribute(attributeName: String): JsNode = createAttribute(attributeName.js)

    /**
     * Creates a new event object of the specified type.
     * Corresponds to `document.createEvent(type)`.
     */
    fun createEvent(type: JsString): JsDomEvent =
        JsDomEvent.syntax(ChainOperation(this, InvocationOperation("createEvent", type)))

    fun createEvent(type: String): JsDomEvent = createEvent(type.js)

    /**
     * Creates a new `Range` object.
     * Corresponds to `document.createRange()`.
     */
    fun createRange(): JsObject =
        JsObject.syntax(ChainOperation(this, InvocationOperation("createRange")))

    /**
     * Clones a node from an external document.
     * Corresponds to `document.importNode(node, deep)`.
     */
    fun importNode(node: JsNode, deep: JsBoolean): JsNode =
        JsNode.syntax(ChainOperation(this, InvocationOperation("importNode", node, deep)))

    fun importNode(node: JsNode, deep: Boolean): JsNode = importNode(node, deep.js)
 ...
 */
inline fun <reified T : JsHtmlElement> JsDocument.getElementById(id: JsString): T = provide(ChainOperation(this, InvocationOperation("getElementById", id)))

inline fun <reified T : JsHtmlElement> JsDocument.getElementById(id: String): T = getElementById(id.js)
 ...
 */
inline fun <reified T : JsHtmlElement> JsDocument.createElement(tagName: JsString): T = provide(ChainOperation(this, InvocationOperation("createElement", tagName)))

inline fun <reified T : JsHtmlElement> JsDocument.createElement(tagName: String): T = createElement(tagName.js)